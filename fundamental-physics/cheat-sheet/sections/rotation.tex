...
\vec{r} & \alpha \\
\frac{\diff\vec{r}}{\diff t} = \vec{v}\quad\left[\frac{\text{м}}{\text{с}}\right] & \frac{\diff\alpha}{\diff t} = \vec{\omega}\quad\left[\frac{\text{рад}}{\text{с}}\right] \\
...
\frac{\diff \vec{p}}{\diff t} = \vec{f} & \frac{\diff \vec{L}}{\diff t} = \vec{M} \\
\end{tblr}
...
\text{Точечные массы} & I = \sum\limits_{i} m_i r_i^2 = m_1r_1^2 + m_2r_2^2 + \cdots + m_nr_n^2 \\
