...
\textbf{Дифракция} --- явление огибания волнами препятствий, встречающихся на их пути, или отклонение волн от прямолинейного распространения при прохождении через отверстия.
