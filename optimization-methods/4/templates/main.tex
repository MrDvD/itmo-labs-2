...
\[
  \begin{cases}
    \frac{\partial f}{\partial x} = 2ax+cy+d= 2 \cdot [[A]]x + [[C]]y + [[D]] = 0 \\
    \frac{\partial f}{\partial y} = 2by+cx+e= 2 \cdot [[B]]y + [[C]]x + [[E]] = 0
  \end{cases}
\]
...
\begin{itemize}
    \item \( \Delta_1 = \frac{\partial^2 f}{\partial x^2}(x^\ast,y^\ast) = 2 \cdot [[A]] = [[DELTA_1]]>0 \).
