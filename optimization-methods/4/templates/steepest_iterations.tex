...
\begin{enumerate}
  ...
  \[
  \begin{gathered}
    \beta^{([[K]])}_1=\textrm{arg}\,\min_{\beta}f(x^{([[K_PREV]])}+\beta u^{([[K]])})=-\dfrac{2ax^{([[K_PREV]])}_1u_1^{([[K]])}+2bx_2^{([[K_PREV]])}u_2^{([[K]])}+c(x_1^{([[K]])}u_2^{([[K]])}+x^{([[K_PREV]])}_2u_1^{([[K]])})+du_1^{([[K]])}+eu_2^{([[K]])}}{2(a(u_1^{([[K]])})^2)+b(u_2^{([[K]])})^2+cu_1^{([[K]])}u_2^{([[K]])}}=\\
