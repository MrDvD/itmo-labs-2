...
\begin{enumerate}
  ...
  \begin{center}
    ...
    \input{tikz/P_plot} & \input{tikz/P1_plot} \\
  ...
  \begin{center}
    ...
    \input{tikz/P1_plot} & \input{tikz/P2_plot} \\
  ...
  \begin{center}
    ...
    \input{tikz/P2_plot} & \input{tikz/P3_plot} \\
  ...
  \begin{center}
    ...
    \input{tikz/P3_plot} & \input{tikz/P4_plot} \\
  ...
  \begin{center}
      ...
      \input{tikz/P4_plot} & \input{tikz/Q_plot} \\
      Множество \( P_4 \) & Множество \( P_5=\omega_5(P_4)=Q \) \\
      \end{tblr}
  \end{center}
\end{enumerate}
...
\begin{center}
      ...
      \input{tikz/Q_plot} & \input{tikz/P4_plot} \\
...
\begin{center}
    ...
    \input{tikz/P4_plot} & \input{tikz/P3_plot} \\
...
\begin{center}
    ...
    \input{tikz/P3_plot} & \input{tikz/P2_plot} \\
...
\begin{center}
    ...
    \input{tikz/P2_plot} & \input{tikz/P1_plot} \\
...
\begin{center}
    ...
    \input{tikz/P1_plot} & \input{tikz/P_plot} \\
    Множество \( Q_4 \) & Множество \( Q_5=z_5(Q_4)=P \) \\
    \end{tblr}
  \end{center}
\end{enumerate}
