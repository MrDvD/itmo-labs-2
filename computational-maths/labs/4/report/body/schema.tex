...
\begin{itemize}
  ...
  \item \(M\) --- максимально допустимое число итераций; целое число.
...
Остановка итерационного процесса происходит при достижении заданной точности \(\varepsilon\) (\(|I_k - I_{k-1}| < \varepsilon\)) или при превышении лимита итераций \(M\).
